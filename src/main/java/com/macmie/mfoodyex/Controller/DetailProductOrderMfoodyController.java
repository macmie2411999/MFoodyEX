...
public class DetailProductOrderMfoodyController {
        ...
        public ResponseEntity<?> getAllDetailProductOrderMfoodys(Principal principal) {
                ...
                List<DetailProductOrderMfoody> detailProductOrderMfoodyList = detailProductOrderMfoodyInterfaceService
                                .getListDetailProductOrderMfoodys();
                // if (detailProductOrderMfoodyList.isEmpty()) {
                // return new ResponseEntity<>("NO_CONTENT List of DetailProductOrderMfoodys",
        ...
        public ResponseEntity<?> getAllDetailProductOrderMfoodysByIdOrder(@PathVariable("ID") int ID,
                ...
                if (orderMfoody == null) {
                        return new ResponseEntity<>("NOT_FOUND OrderMfoody with idOrder: " + ID,
                                        HttpStatus.NOT_FOUND);
                }

                List<DetailProductOrderMfoody> detailProductOrderMfoodyList = detailProductOrderMfoodyInterfaceService
                                .getListDetailProductOrderMfoodysByIdOrder(ID);

                if (detailProductOrderMfoodyList == null) {
                        return new ResponseEntity<>("NOT_FOUNDList of DetailProductOrderMfoodys with idOrder: " + ID,
                                        HttpStatus.NOT_FOUND);
                }
        ...
        public ResponseEntity<?> getAllDetailProductOrderMfoodysByIdProduct(@PathVariable("ID") int ID,
                ...
                List<DetailProductOrderMfoody> detailProductOrderMfoodyList = detailProductOrderMfoodyInterfaceService
                                .getListDetailProductOrderMfoodysByIdProduct(ID);
                if (detailProductOrderMfoodyList == null) {
                        return new ResponseEntity<>(
                                        "NOT_FOUND List of DetailProductOrderMfoodys with idProduct: " + ID,
                                        HttpStatus.NOT_FOUND);
                }
                return new ResponseEntity<>(detailProductOrderMfoodyList, HttpStatus.OK);
        }
        ...
        public ResponseEntity<?> getDetailProductOrderMfoodyByID(@PathVariable("IdOrder") int idOrder,
                ...
                UserMfoody currentUserMfoody = currentOrderMfoody.getUser();
                if (currentUserMfoody == null) {
                        return new ResponseEntity<>("NOT_FOUND UserMfoody with idOrder: " + idOrder,
                                        HttpStatus.NOT_FOUND);
                }
                ...
                DetailProductOrderMfoody detailProductOrderMfoody = detailProductOrderMfoodyInterfaceService
                                .getDetailProductOrderMfoodyByIOrderAndIdProduct(idOrder, idProduct);
                if (detailProductOrderMfoody == null) {
                        return new ResponseEntity<>(
                                        "NOT_FOUND DetailProductOrderMfoody with idOrder: " + idOrder + ", idProduct: "
                                                        + idProduct,
                                        HttpStatus.NO_CONTENT);
                }
        ...
        public ResponseEntity<?> deleteDetailProductOrderMfoodyByIDs(@PathVariable("IdOrder") int idOrder,
                ...
                try {
                        detailProductOrderMfoodyInterfaceService
                                        .deleteDetailProductOrderMfoodyByIdDetailProductOrderMfoody(
                                                        idOrder, idProduct);
                } catch (Exception e) {
        ...
        public ResponseEntity<?> deleteAllDetailProductOrderMfoodysByIdOrder(@PathVariable("ID") int ID,
                ...
                try {
                        ...
                        log.error("An error occurred while deleting List of DetailProductOrderMfoodys with idOrder: "
                                        + ID);
                        log.error("Detail Error: " + e);
                        // throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,
                        // "INTERNAL_SERVER_ERROR Exceptions occur when deleting List of
                        // DetailProductOrderMfoodys");
                        return new ResponseEntity<>("BAD_REQUEST Something Wrong!", HttpStatus.BAD_REQUEST);
                }
        ...
        public ResponseEntity<?> deleteAllDetailProductOrderMfoodysByIdProduct(@PathVariable("ID") int ID,
                ...
                try {
                        ...
                        log.error("An error occurred while deleting List of DetailProductOrderMfoodys with idProduct: "
                                        + ID);
                        log.error("Detail Error: " + e);
                        // throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,
                        // "INTERNAL_SERVER_ERROR Exceptions occur when deleting List of
        ...
        /*
         * 1. idOrder and idProduct in Json must be accurate, salePrice/fullPrice in
         * Json are ignored
         * 2. salePrice/fullPrice of DetailProductOrderMfoody are fetched from
         * ProductMfoody
         */
        @Secured({ ROLE_ADMIN_SECURITY, ROLE_USER_SECURITY })
        @PutMapping(URL_EDIT)
        public ResponseEntity<?> editDetailProductOrderMfoody(@RequestBody String detailProductOrderPOJOJsonObject,
                ...
                try {
                        ...
                        Gson gson = new Gson();
                        DetailProductOrderMfoodyPOJO newDetailProductOrderMfoodyPOJO = gson
                                        .fromJson(detailProductOrderPOJOJsonObject, DetailProductOrderMfoodyPOJO.class);
                        ...
                        // DetailProductOrderMfoody
                        if (!applicationCheckAuthorController.checkAuthorization(principal,
                                        newOrderMfoody.getUser().getIdUser())) {
                                return new ResponseEntity<>("FORBIDDEN Authorization failed!", HttpStatus.FORBIDDEN);
                        }

                        // Add IdDetailProductOrderMfoody, ProductMfoody, and OrderMfoody; re-assign
                        // values for salePrice/fullPrice from ProductMfoody
                        ...
                        newDetailProductOrderMfoody
                                        .setSalePriceDetailProductOrder(newProductMfoody.getSalePriceProduct());
                        newDetailProductOrderMfoody
                                        .setFullPriceDetailProductOrder(newProductMfoody.getFullPriceProduct());

                        // Save to DB and Update associated OrderMfoody
                        detailProductOrderMfoodyInterfaceService
                                        .updateDetailProductOrderMfoody(newDetailProductOrderMfoody);
                        log.info("DetailProductOrderMfoody with ID: {} by {} is edited",
                                        newDetailProductOrderMfoody.getIdDetailProductOrderMfoody(),
                                        principal.getName());
         ...
         * 2. salePrice/fullPrice of DetailProductOrderMfoody are fetched from
         * ProductMfoody
         * 3. The threat is any UserMfoodys can create DetailProductOrderMfoodys using
        ...
        public ResponseEntity<?> addNewDetailProductOrderMfoody(@RequestBody String detailProductOrderPOJOJsonObject,
                ...
                try {
                        ...
                        DetailProductOrderMfoodyPOJO newDetailProductOrderMfoodyPOJO = gson
                                        .fromJson(detailProductOrderPOJOJsonObject, DetailProductOrderMfoodyPOJO.class);
                        DetailProductOrderMfoody newDetailProductOrderMfoody = newDetailProductOrderMfoodyPOJO
                                        .renderDetailProductOrderMfoody();
                        ...
                        // If the DetailProductOrderMfoodys is already in the DB, update it and update
                        // associated OrderMfoody
                        if (checkNewDetailProductOrderMfoody != null) {
                                checkNewDetailProductOrderMfoody.setQuantityDetailProductOrder(
                                                checkNewDetailProductOrderMfoody.getQuantityDetailProductOrder()
                                                                + newDetailProductOrderMfoodyPOJO
                                                                                .getQuantityDetailProductOrder());
                        ...
                        newDetailProductOrderMfoody.setIdDetailProductOrderMfoody(
                                        new DetailProductOrderMfoodyId(newDetailProductOrderMfoodyPOJO.getIdOrder(),
                                                        newDetailProductOrderMfoodyPOJO.getIdProduct()));
                        ...
                        detailProductOrderMfoodyInterfaceService
                                        .saveDetailProductOrderMfoody(newDetailProductOrderMfoody);
        ...
        public ResponseEntity<?> addNewArrayDetailProductOrderMfoody(
                        @RequestBody String detailProductOrderPOJOJsonObject,
                        Principal principal) {
                try {
                        // Convert JsonObject to array of DetailProductOrderPOJO objects
                        Gson gson = new Gson();
                        DetailProductOrderMfoodyPOJO[] detailProductOrderMfoodyPOJOs = gson.fromJson(
                                        detailProductOrderPOJOJsonObject, DetailProductOrderMfoodyPOJO[].class);

                        for (DetailProductOrderMfoodyPOJO newDetailProductOrderMfoodyPOJO : detailProductOrderMfoodyPOJOs) {
                                DetailProductOrderMfoody newDetailProductOrderMfoody = newDetailProductOrderMfoodyPOJO
                                                .renderDetailProductOrderMfoody();
                                ...
                                if (checkNewDetailProductOrderMfoody != null) {
                                        ...
                                        // If the DetailProductOrderMfoodys is completely new, add new
                                        newDetailProductOrderMfoody.setIdDetailProductOrderMfoody(
                                                        new DetailProductOrderMfoodyId(
                                                                        newDetailProductOrderMfoodyPOJO.getIdOrder(),
                                                                        newDetailProductOrderMfoodyPOJO
                                                                                        .getIdProduct()));
                                        newDetailProductOrderMfoody.setProduct(productMfoody);
                                        newDetailProductOrderMfoody.setFullPriceDetailProductOrder(
                                                        productMfoody.getFullPriceProduct());
                                        newDetailProductOrderMfoody.setSalePriceDetailProductOrder(
                                        ...
                                        detailProductOrderMfoodyInterfaceService
                                                        .saveDetailProductOrderMfoody(newDetailProductOrderMfoody);
                                        log.info("New ArrayDetailProductOrderMfoody is created by " + principal.getName());
                                        processOrderMfoody(newDetailProductOrderMfoodyPOJO.getIdOrder());
                                }
                        }
                        ...
                        log.error("An error occurred while adding ArrayDetailProductOrderMfoody");
                        log.error("Detail Error: " + e);
                        return new ResponseEntity<>("BAD_REQUEST Something Wrong!", HttpStatus.BAD_REQUEST);
                }
        }
        ...
        public void processOrderMfoody(int idOrderMfoody) {
                ...
                if (!detailProductOrderMfoodyList.isEmpty()) {
                        for (DetailProductOrderMfoody element : detailProductOrderMfoodyList) {
                                ...
                                totalSalePriceOrder += element.getQuantityDetailProductOrder()
                                                * element.getSalePriceDetailProductOrder();
                                totalFullPriceOrder += element.getQuantityDetailProductOrder()
                                                * element.getFullPriceDetailProductOrder();
                        }
                }
