...
public class DetailProductCartMfoodyController {
    ...
    public ResponseEntity<?> getAllDetailProductCartMfoodysByIdProduct(@PathVariable("ID") int ID, Principal principal) {
    ...
    public ResponseEntity<?> deleteDetailProductCartMfoodyByID(@PathVariable("IdCart") int idCart,
        ...
        try {
            ...
            log.error("An error occurred while deleting DetailProductCart with idCart: {} and idProduct: {}", idCart, idProduct);
    ...
    public ResponseEntity<?> deleteAllDetailProductCartMfoodysByIdCart(@PathVariable("ID") int ID, Principal principal) {
